...
export default function Contact() {
  ...
  return (
    <div ref={rootRef} className="pb-24 sm:pb-32" aria-label="Contact Nexus Gaming Cafe">
      {/* Header */}
      <div className="bg-bg2 border-b border-white/8 pt-20 pb-16 sm:pt-28 sm:pb-24">
        <div className="container contact-header-anim">
      ...
      <div className="container pt-12 sm:pt-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-14">
          ...
          <div className="flex flex-col gap-6 sm:gap-8 contact-content-anim">
            <div className="bg-surface border border-white/8 rounded-xl p-7 sm:p-8">
          ...
          <div className="lg:col-span-2 contact-content-anim">
            {sent ? (
              <div className="bg-surface border border-available/20 rounded-xl p-12 text-center">
                <div className="w-16 h-16 rounded-full bg-available/10 border border-available/20 flex items-center justify-center mx-auto mb-7">
                ...
                <h3 className="font-display font-bold text-2xl text-text mb-3">Message Sent!</h3>
                <p className="text-muted text-sm max-w-md mx-auto leading-relaxed">We'll get back to you within 24 hours. See you at Nexus.</p>
              ...
              <div className="bg-surface border border-white/8 rounded-xl p-7 sm:p-9">
            ...
            {/* Map banner */}
            <div className="mt-10 bg-surface border border-white/8 rounded-xl overflow-hidden min-h-[200px] sm:min-h-[240px] flex items-center justify-center p-8 text-center">
              <div>
                ...
                <div className="font-display font-bold text-base text-text mb-1">Nexus Gaming Cafe</div>
